<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Produksi/Request_Permintaan_Barang">Data Permintaan Barang</a></li>
...
<div class="row">
    ...
    <div class="col-lg-12 grid-margin">
		<button id="simpan" type="submit" class="btn btn-primary" style="width: 10%;"><i class="fa fa-save"></i> Simpan</button>
        <a href="<?= base_url() ?>Produksi/Permintaan_Barang"><button class="btn btn-secondary"><i data-feather="arrow-left-circle"></i> Back</button></a>
    </div>
</div>
