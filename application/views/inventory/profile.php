                ...
                <div class="card rounded">
                    ...
                    <form action="" id="form_edit" enctype="multipart/form-data">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?= base_url() ?>Inventory"><button class="btn btn-secondary" type="button"><i class="fa fa-arrow-circle-o-left"></i> Back</button></a>
                            <!-- </div> -->
                        </div>
                    </form>
                </div>
...
<!-- endinject -->
<script src="<?= base_url() ?>assets/public/js/profile.js"></script>
